export type PlatformType = 'INSTAGRAM' | 'FACEBOOK' | 'TIKTOK' | 'YOUTUBE' | 'X' | 'LINKEDIN' | 'THREADS' | 'PINTEREST' | 'TELEGRAM' | 'DISCORD' | 'SLACK' | 'REDDIT' | 'GOOGLE_BUSINESS';
...
export type PostStatus = 'DRAFT' | 'PROCESSING' | 'READY' | 'SCHEDULED' | 'PUBLISHING' | 'PUBLISHED' | 'PARTIALLY_PUBLISHED' | 'FAILED' | 'CANCELLED';
export type ToneOption = 'Professional' | 'Viral' | 'Casual' | 'Sales' | 'Storytelling' | 'Educational' | 'Humor';
export type TranscodingPresetName = 'VERTICAL_SHORT_VIDEO' | 'LANDSCAPE_VIDEO' | 'SQUARE_VIDEO' | 'INSTAGRAM_REEL' | 'TIKTOK_VIDEO' | 'YOUTUBE_SHORT' | 'SQUARE_IMAGE' | 'STORY_IMAGE';
