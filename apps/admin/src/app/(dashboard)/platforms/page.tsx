...
const PRESET_TEMPLATES: Record<string, Partial<PlatformItem>> = {
  ...
  quora: {
    ...
    logoUrl: 'https://cdn.simpleicons.org/quora/B92B27',
    authUrl: 'https://www.quora.com/oauth/authorize',
    tokenUrl: 'https://api.quora.com/oauth/token',
    apiBaseUrl: 'https://api.quora.com/v1/',
    scopes: 'read,write,publish_answers,manage_spaces',
    developerPortalUrl: 'https://www.quora.com/about/resources',
  ...
  snapchat: {
    ...
    maxVideoSizeMB: 32,
    maxVideoDurationSec: 60,
    capabilities: { images: true, video: true, stories: true, reels: false, shorts: false, scheduling: true, analytics: true, comments: false, deletion: true },
  },
};
...
const INITIAL_PLATFORMS: PlatformItem[] = [
  ...
  },
  {
    ...
    publishingStatus: 'OPERATIONAL',
    analyticsStatus: 'OPERATIONAL',
    connectedAccountsCount: 190,
    rateLimitUsedPercent: 4.2,
    clientId: 'quora_app_client_91823',
    clientSecret: '••••••••••••••••••••••••••••••••',
    callbackUrl: 'https://omnipost-api.onrender.com/api/v1/auth/callback/quora',
    developerPortalUrl: 'https://www.quora.com/about/resources',
    capabilities: { images: true, video: true, stories: false, reels: false, shorts: false, scheduling: true, analytics: true, comments: true, deletion: true },
  },
  {
    ...
    publishingStatus: 'OPERATIONAL',
    analyticsStatus: 'OPERATIONAL',
    connectedAccountsCount: 780,
    rateLimitUsedPercent: 18.5,
    clientId: 'fb_app_9182746192',
    clientSecret: '••••••••••••••••••••••••••••••••',
    callbackUrl: 'https://omnipost-api.onrender.com/api/v1/auth/callback/facebook',
    developerPortalUrl: 'https://developers.facebook.com/apps/',
    capabilities: { images: true, video: true, stories: true, reels: true, shorts: false, scheduling: true, analytics: true, comments: true, deletion: true },
  },
  {
    ...
    publishingStatus: 'OPERATIONAL',
    analyticsStatus: 'OPERATIONAL',
    connectedAccountsCount: 260,
    rateLimitUsedPercent: 6.1,
    clientId: 'slack_client_91823',
    clientSecret: '••••••••••••••••••••••••••••••••',
    callbackUrl: 'https://omnipost-api.onrender.com/api/v1/auth/callback/slack',
    developerPortalUrl: 'https://api.slack.com/apps',
    capabilities: { images: true, video: true, stories: false, reels: false, shorts: false, scheduling: true, analytics: false, comments: true, deletion: true },
  },
  {
    id: 'plat-google-business',
    name: 'Google Business',
    slug: 'google_business',
    category: 'Local & Search',
    logoUrl: 'https://cdn.simpleicons.org/google/4285F4',
    ...
    publishingStatus: 'OPERATIONAL',
    analyticsStatus: 'OPERATIONAL',
    connectedAccountsCount: 140,
    rateLimitUsedPercent: 3.2,
    clientId: 'google_biz_app_91823',
    clientSecret: '••••••••••••••••••••••••••••••••',
    callbackUrl: 'https://omnipost-api.onrender.com/api/v1/auth/callback/google_business',
    developerPortalUrl: 'https://console.cloud.google.com/apis/credentials',
    capabilities: { images: true, video: true, stories: false, reels: false, shorts: false, scheduling: true, analytics: true, comments: true, deletion: true },
  },
  {
    ...
    publishingStatus: 'OPERATIONAL',
    analyticsStatus: 'OPERATIONAL',
    connectedAccountsCount: 115,
    rateLimitUsedPercent: 2.7,
    clientId: 'snap_app_client_91823',
    clientSecret: '••••••••••••••••••••••••••••••••',
    callbackUrl: 'https://omnipost-api.onrender.com/api/v1/auth/callback/snapchat',
    developerPortalUrl: 'https://business.snapchat.com/',
    capabilities: { images: true, video: true, stories: true, reels: false, shorts: false, scheduling: true, analytics: true, comments: false, deletion: true },
  },
];
